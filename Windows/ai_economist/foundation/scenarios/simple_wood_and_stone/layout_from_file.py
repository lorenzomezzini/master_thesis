...
class LayoutFromFile(BaseEnvironment):
    ...
    def __init__(
        ...
        **base_env_kwargs
        ...
        # Load in the layout
        path_to_layout_file = "C:/Users/maltempi francesca/Desktop/Ke bll ke è lollo/master_thesis/Windows/map_txt/quadrant_25x25_20each_30clump.txt"
    ...
    def scenario_metrics(self):
        ...
        metrics["tax"] = self.get_component('PeriodicBracketTax').get_metrics()
